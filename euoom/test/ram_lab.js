...
export async function main(ns) {
    const tests = [
        ...
        // --- [Special: Hacknet Deep Dive (21 Methods)] ---
        { name: "HN: numNodes", path: "/euoom/test/functions/dynamic_hacknet_numNodes.js", staticRam: 0.0 },
        { name: "HN: purchaseNode", path: "/euoom/test/functions/dynamic_hacknet_purchaseNode.js", staticRam: 0.0 },
        { name: "HN: getNodeStats", path: "/euoom/test/functions/dynamic_hacknet_getNodeStats.js", staticRam: 0.0 },
        { name: "HN: upgradeLevel", path: "/euoom/test/functions/dynamic_hacknet_upgradeLevel.js", staticRam: 0.0 },
        { name: "HN: upgradeRam", path: "/euoom/test/functions/dynamic_hacknet_upgradeRam.js", staticRam: 0.0 },
        { name: "HN: upgradeCore", path: "/euoom/test/functions/dynamic_hacknet_upgradeCore.js", staticRam: 0.0 },
        { name: "HN: getPurNodeCost", path: "/euoom/test/functions/dynamic_hacknet_getPurchaseNodeCost.js", staticRam: 0.0 },
        { name: "HN: getUpLevelCost", path: "/euoom/test/functions/dynamic_hacknet_getUpgradeLevelCost.js", staticRam: 0.0 },
        { name: "HN: getUpRamCost", path: "/euoom/test/functions/dynamic_hacknet_getUpgradeRamCost.js", staticRam: 0.0 },
        { name: "HN: getUpCoreCost", path: "/euoom/test/functions/dynamic_hacknet_getUpgradeCoreCost.js", staticRam: 0.0 },
        { name: "HN: numHashes", path: "/euoom/test/functions/dynamic_hacknet_numHashes.js", staticRam: 0.0 },
        { name: "HN: maxHashes", path: "/euoom/test/functions/dynamic_hacknet_maxHashes.js", staticRam: 0.0 },
        { name: "HN: spendHashes", path: "/euoom/test/functions/dynamic_hacknet_spendHashes.js", staticRam: 0.0 },
        { name: "HN: getHashUpgrades", path: "/euoom/test/functions/dynamic_hacknet_getHashUpgrades.js", staticRam: 0.0 },
        { name: "HN: getHashUpLvl", path: "/euoom/test/functions/dynamic_hacknet_getHashUpgradeLevel.js", staticRam: 0.0 },
        { name: "HN: getHashUpLvlCost", path: "/euoom/test/functions/dynamic_hacknet_getHashUpgradeLevelCost.js", staticRam: 0.0 },
        { name: "HN: upgradeCache", path: "/euoom/test/functions/dynamic_hacknet_upgradeCache.js", staticRam: 0.0 },
        { name: "HN: getUpCacheCost", path: "/euoom/test/functions/dynamic_hacknet_getUpgradeCacheCost.js", staticRam: 0.0 },
        { name: "HN: getStudyMult", path: "/euoom/test/functions/dynamic_hacknet_getStudyMult.js", staticRam: 0.0 },
        { name: "HN: getTrainMult", path: "/euoom/test/functions/dynamic_hacknet_getTrainingMult.js", staticRam: 0.0 },
        { name: "HN: hashCapacity", path: "/euoom/test/functions/dynamic_hacknet_hashCapacity.js", staticRam: 0.0 },
